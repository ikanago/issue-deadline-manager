...
async function run() {
    const a = new Date(2021, 10, 12, 23, 15);
    const b = new Date(2021, 10, 14, 0, 20);
    console.log((0, date_fns_1.format)(a, 'yyyy-mm-dd'));
    console.log((0, date_fns_tz_1.zonedTimeToUtc)(a, "Japan/Tokyo"));
    console.log((0, date_fns_1.intervalToDuration)({ start: a, end: b }));
    try {
        const done = await (0, wait_1.wait)(0);
        core.debug(done);
    }
    catch (error) {
